...
\geometry{left=2.0cm, top=2.0cm, right=2.0cm, bottom=1.8cm, footskip=.5cm}
...
\mobile{(+382) 69-304-713}
\email{jj1652@nyu.edu}
%\homepage{www.posquit0.com}
\github{sherl0ck-}
\linkedin{jovanjovancevic}
% \gitlab{gitlab-id}
% \stackoverflow{SO-id}{SO-name}
% \twitter{@twit}
% \skype{skype-id}
% \reddit{reddit-id}
\extrainfo{Podgorica, Montenegro}
